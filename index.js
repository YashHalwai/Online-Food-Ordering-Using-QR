...
function displayItems(){
    var pureveg= document.getElementById('pureveg');
    ...
    const purevegData= foodItem.filter((item)=>item.category=='pureveg');
    ...
    const juiceData= foodItem.filter((item)=>item.category=='juice');
    purevegData.map(item=>{
